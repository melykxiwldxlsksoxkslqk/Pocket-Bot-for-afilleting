...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
	...
	"en": {
		...
		"welcome.message": "👋 Welcome! I'm BotX BOT — your reliable assistant in the trading world.\n\nMy goal is to provide quality trading signals and educational materials so you can navigate financial markets with confidence.\n\nUse the navigation buttons below: ‘Trading signals’ or ‘Educational materials’.👇",
